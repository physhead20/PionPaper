...
// ### Load Data Plots      ###
// ############################
//TFile *f1=new TFile("./PionXSection_histos.root");
TFile *f1=new TFile("./PionXSection_histos_Step2b.root");


 TH1F* hDataInc = (TH1F*)f1->Get("hdataPionIncidentKE");
 TH1F* hDataInt = (TH1F*)f1->Get("fPionInteractions");
 TH1F* DataCrossSection = (TH1F*)f1->Get("fCrossSection");
    ...
    // ===============================================================================================================
    // 					SCALING FOR THE electron CONTAMINATION
    // ==========================================================================================================
    //Here we assume an overall electron contamination that is uniform/flat in energy
    //The residual electron correction can be improved, with a bin-by-bin correction both in Ninc and Nint
    
    double ElectronContaminationScaleFactorInc = 0.97; //3% electrons in Ninc
    double ElectronContaminationScaleFactorInt = 0.95; //5% electrons in Nint
    
    hDataInc->Scale(ElectronContaminationScaleFactorInc);
    hDataInt->Scale(ElectronContaminationScaleFactorInt);
 ...
 for (int i = 1; i <= nbins; i++ ) {
   ...
   //Bin by Bin correction for PiDecay (MC estimates)
     if(i == 1 ){ datan = datan*0.965;}
     if(i == 2 ){ datan = datan*0.95;}
     if(i == 3 ){ datan = datan*0.988;}
     else if(i > 3){ datan = datan*0.997;}
     
   /* //Bin by Bin correction for PiDecay & PiCapture (MC estimates)
     if(i == 1 ){ datan = datan*0.965*0.43;}
     if(i == 2 ){ datan = datan*0.95*0.93;}
     if(i == 3 ){ datan = datan*0.988*0.993;}
     else if(i > 3){ datan = datan*0.997;}*/
...
// ############################
 ...
 TFile *f2=new TFile("./PionMCXSection_histos_NewMC_Step2b.root");
 
 
 TH1F* hMCInc = (TH1F*)f2->Get("hdataPionIncidentKE");
 TH1F* hMCInt = (TH1F*)f2->Get("fPionInteractions");
 ...
 for (int i = 1; i <= nbinsMC; i++ ) {
   MCn = hMCInt->GetBinContent(i);
     ...
     //Bin by Bin correction for PiDecay (MC estimates)
     if(i == 1 ){ MCn = MCn*0.965;}
     if(i == 2 ){ MCn = MCn*0.95;}
     if(i == 3 ){ MCn = MCn*0.988;}
     else if(i > 3){ MCn = MCn*0.997;}
     
     //Bin by Bin correction for PiDecay & PiCapture (MC estimates)
     /*if(i == 1 ){ MCn = MCn*0.965*0.43;}
     if(i == 2 ){ MCn = MCn*0.95*0.93;}
     if(i == 3 ){ MCn = MCn*0.988*0.993;}
     else if(i > 3){ MCn = MCn*0.997;}*/
