...
// ### Load Data Plots ###
// #######################
TFile *f1 = new TFile("../DataAnalysis/PionXSection_Irene_histos.root");
...
TH1F *hDataInKE = (TH1F*)f1->Get("hdataPionIncidentKE");
...
// ### Getting the data Incident Kinetic Energy plot ###
TH1F *hDataIntKE = (TH1F*)f1->Get("fPionInteractions");
